...
include mk/platform/board_px4fmu24.mk

# support building PX4 images for this platform
px4fmu24_freertos_SUPPORT_PX4IMG := 1

# platform argument for tower builds
px4fmu24_freertos_TOWER_PLATFORM := px4fmu24

# operating system argument for tower builds
px4fmu24_freertos_TOWER_OS := freertos

# px4 image prototype
px4fmu24_freertos_PX4_IMG_PROTO := px4fmu24
