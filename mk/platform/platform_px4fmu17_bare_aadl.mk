...
px4fmu17_bare_aadl_SUPPORT_PX4IMG := 1

# platform argument for tower builds
px4fmu17_bare_aadl_TOWER_PLATFORM := px4fmu17_bare

# operating system argument for tower builds
px4fmu17_bare_aadl_TOWER_OS := aadl

# px4 image prototype
px4fmu17_bare_aadl_PX4_IMG_PROTO := px4fmu17
