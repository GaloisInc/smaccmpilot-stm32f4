                                  ...
                                  uint8_t* n_var1)
{
    ...
    *&n_var0->mission_item_seq = n_r7;
    ...
    uint16_t n_r8 = smavlink_unpack_uint16_t(n_var1, 30U);
    
    *&n_var0->command = n_r8;
    
    uint8_t n_r9 = smavlink_unpack_uint8_t(n_var1, 32U);
    
    *&n_var0->target_system = n_r9;
    
    uint8_t n_r10 = smavlink_unpack_uint8_t(n_var1, 33U);
    
    *&n_var0->target_component = n_r10;
    
    uint8_t n_r11 = smavlink_unpack_uint8_t(n_var1, 34U);
    
    *&n_var0->frame = n_r11;
    
    uint8_t n_r12 = smavlink_unpack_uint8_t(n_var1, 35U);
    
    *&n_var0->current = n_r12;
    
    uint8_t n_r13 = smavlink_unpack_uint8_t(n_var1, 36U);
