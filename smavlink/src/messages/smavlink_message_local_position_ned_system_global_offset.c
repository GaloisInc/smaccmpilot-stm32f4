...
void smavlink_send_local_position_ned_system_global_offset(struct local_position_ned_system_global_offset_msg* n_var0,
                                                           ...
                                                           struct smavlink_system* n_var2)
{
    ...
    smavlink_send_ivory(n_var1, n_var2, 89U, (uint8_t*) n_ref1, 28U, 231U);
    return;
}
