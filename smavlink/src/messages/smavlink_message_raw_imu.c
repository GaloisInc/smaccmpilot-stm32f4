                           ...
                           struct smavlink_system* n_var2)
{
    ...
    smavlink_pack_int16_t((uint8_t*) n_ref1, 18U, n_deref8);
    
    int16_t n_deref9 = *&n_var0->xmag;
    
    smavlink_pack_int16_t((uint8_t*) n_ref1, 20U, n_deref9);
    
    int16_t n_deref10 = *&n_var0->ymag;
    
    smavlink_pack_int16_t((uint8_t*) n_ref1, 22U, n_deref10);
    
    int16_t n_deref11 = *&n_var0->zmag;
    
    smavlink_pack_int16_t((uint8_t*) n_ref1, 24U, n_deref11);
...
void smavlink_unpack_raw_imu(struct raw_imu_msg* n_var0, const uint8_t** n_var1)
{
    ...
    *&n_var0->ygyro = n_r5;
    ...
    int16_t n_r6 = smavlink_unpack_int16_t(n_var1, 18U);
    
    *&n_var0->zgyro = n_r6;
    
    int16_t n_r7 = smavlink_unpack_int16_t(n_var1, 20U);
    
    *&n_var0->xmag = n_r7;
    
    int16_t n_r8 = smavlink_unpack_int16_t(n_var1, 22U);
    
    *&n_var0->ymag = n_r8;
    
    int16_t n_r9 = smavlink_unpack_int16_t(n_var1, 24U);
