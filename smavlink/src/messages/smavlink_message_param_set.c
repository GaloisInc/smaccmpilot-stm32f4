                             ...
                             struct smavlink_system* n_var2)
{
    ...
    for (int32_t n_ix7 = 0 % 16; n_ix7 <= 15 % 16; n_ix7 = n_ix7 + 1) {
        uint8_t n_deref8 = *&n_let6[n_ix7];
        
        smavlink_pack_uint8_t((uint8_t*) n_ref1, 6U + (uint8_t) n_ix7,
                              n_deref8);
    }
                               ...
                               uint8_t* n_var1)
{
    ...
    *&n_var0->param_type = n_r3;
    for (int32_t n_ix4 = 0 % 16; n_ix4 <= 15 % 16; n_ix4 = n_ix4 + 1) {
        uint8_t n_r5 = smavlink_unpack_uint8_t(n_var1, 6U + (uint8_t) n_ix4);
