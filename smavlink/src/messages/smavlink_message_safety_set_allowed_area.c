                                           ...
                                           struct smavlink_system* n_var2)
{
    ...
    smavlink_pack_uint8_t((uint8_t*) n_ref1, 26U, n_deref10);
    smavlink_send_ivory(n_var1, n_var2, 54U, (uint8_t*) n_ref1, 27U, 15U);
    return;
}
                                             ...
                                             const uint8_t** n_var1)
{
    ...
    *&n_var0->target_component = n_r7;
    ...
    uint8_t n_r8 = smavlink_unpack_uint8_t(n_var1, 26U);
