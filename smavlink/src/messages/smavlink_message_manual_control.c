                                    ...
                                    uint8_t** n_var1)
{
    ...
    *&n_var0->y = n_r1;
    ...
    int16_t n_r2 = smavlink_unpack_int16_t(n_var1, 4U);
    
    *&n_var0->z = n_r2;
    
    int16_t n_r3 = smavlink_unpack_int16_t(n_var1, 6U);
    ...
    *&n_var0->buttons = n_r4;
    ...
    uint8_t n_r5 = smavlink_unpack_uint8_t(n_var1, 10U);
