                           ...
                           float var3, float var4, float var5, float var6)
{
    ...
    float let1 = var4 * 57.29578F;
    float let2 = let0 - let1;
    float r3 = pid_update(var0, let2);
    float let4 = var5 * 57.29578F;
    float let5 = r3 - let4;
    float r6 = pid_update(var1, let5);
    float let7 = ((float) r6 < (float) (0.0F - var6) ? 0.0F -
                  var6 : (float) r6 > (float) var6 ? var6 : r6) / var6;
                          ...
                          float var4)
{
    ...
    float let1 = var3 * 57.29578F;
    float let2 = let0 - let1;
    float r3 = pid_update(var0, let2);
    float let4 = ((float) r3 < (float) (0.0F - var4) ? 0.0F -
                  var4 : (float) r3 > (float) var4 ? var4 : r3) / var4;
