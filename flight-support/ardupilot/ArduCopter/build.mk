...
$(ARDUCOPTER_SKETCH_CPP): $(ARDUCOPTER_SKETCH_CPP_SRC)
	gawk -v mode=header -f $(TOP)/ardupilot/mk/splitter.awk $(ARDUCOPTER_SKETCH_CPP_SRC) >  $@
	echo "#line 1 \"autogenerated\""                                                    >> $@
	gawk -f $(TOP)/ardupilot/mk/prototyper.awk $(ARDUCOPTER_SKETCH_CPP_SRC)              >> $@
	gawk -v mode=body -f $(TOP)/ardupilot/mk/splitter.awk $(ARDUCOPTER_SKETCH_CPP_SRC)   >> $@
