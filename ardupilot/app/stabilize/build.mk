...
APP_STABILIZE_OBJECTS  += motorsoutput.o
APP_STABILIZE_OBJECTS  += apmotors_wrapper.o
APP_STABILIZE_OBJECTS  += gcs.o

APP_STABILIZE_CXXFLAGS  = $(ARDUPILOT_CXXFLAGS)
APP_STABILIZE_CXXFLAGS += -I$(TOP)/smavlink/include

APP_STABILIZE_LIBRARIES += libsmavlink.a
