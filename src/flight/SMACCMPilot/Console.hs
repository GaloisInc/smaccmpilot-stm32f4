...
write_u8 :: Def ('[Uint8] :-> ())
write_u8 = importProc "console_write_u8" "apwrapper/console_prim.h"

instance Writable Uint8 where
  write = call_ write_u8

write_s8 :: Def ('[Sint8] :-> ())
write_s8 = importProc "console_write_s8" "apwrapper/console_prim.h"

instance Writable Sint8 where
  write = call_ write_s8

write_u16 :: Def ('[Uint16] :-> ())
write_u16 = importProc "console_write_u16" "apwrapper/console_prim.h"

instance Writable Uint16 where
  write = call_ write_u16

write_s16 :: Def ('[Sint16] :-> ())
write_s16 = importProc "console_write_s16" "apwrapper/console_prim.h"

instance Writable Sint16 where
  write = call_ write_s16

write_u32 :: Def ('[Uint32] :-> ())
write_u32 = importProc "console_write_u32" "apwrapper/console_prim.h"

instance Writable Uint32 where
  write = call_ write_u32

write_s32 :: Def ('[Sint32] :-> ())
write_s32 = importProc "console_write_s32" "apwrapper/console_prim.h"
...
write_float = importProc "console_write_float" "apwrapper/console_prim.h"

instance Writable IFloat where
  write = call_ write_float

write_double :: Def ('[IDouble] :-> ())
write_double = importProc "console_write_double" "apwrapper/console_prim.h"

instance Writable IDouble where
  write = call_ write_double

write_istring :: Def ('[IString] :-> ())
write_istring = importProc "console_write_string" "apwrapper/console_prim.h"

instance Writable IString where
  write = call_ write_istring

write_string_n :: Def ('[ConstRef s (CArray (Stored IChar)), Sint32] :-> ())
write_string_n = importProc "console_write_string_n" "apwrapper/console_prim.h"
...
consoleModule = package "console" $ do
  inclHeader "apwrapper/console_prim.h"
  incl write_u8
  incl write_s8
  incl write_u16
  incl write_s16
