...
ARDUPILOT_LIBINCLUDES += -I$(ARDUPILOT_SRC)/libraries/AP_HAL_SMACCM
ARDUPILOT_LIBINCLUDES += -I$(ARDUPILOT_SRC)/libraries/AP_HAL/utility
ARDUPILOT_LIBINCLUDES += $(addprefix -I,$(wildcard $(ARDUPILOT_SRC)/libraries/*))
ARDUPILOT_LIBINCLUDES += -DCONFIG_HAL_BOARD=HAL_BOARD_SMACCM
ARDUPILOT_LIBINCLUDES += -Wno-psabi

ARDUPILOT_CXXFLAGS += $(FREERTOS_CFLAGS)
ARDUPILOT_CXXFLAGS += -I$(TOP)/src/bsp/hwf4/include
ARDUPILOT_CXXFLAGS += -I$(TOP)/src/bsp/include
...
src/flight/ardupilot/%.cpp: $(ARDUPILOT_SRC)/%.cpp
	mkdir -p $(dir $@)
	cp $< $@
