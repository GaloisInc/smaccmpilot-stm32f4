...
def print_accel(p, sensor, res):
    """Print calibration for mpu6000.accelerometer."""
    print("")
    print("[calibration.mpu6000.accelerometer]")
    print("x_offset="+str(int(round(p[0]))))
    print("y_offset="+str(int(round(p[1]))))
    print("z_offset="+str(int(round(p[2]))))
    print("x_scale="+str(p[3]*2**res/1024))
    print("y_scale="+str(p[4]*2**res/1024))
    print("z_scale="+str(p[5]*2**res/1024))
    print("")


def print_mag(p, sensor, res):
    """Print calibration for lsm303d.magnetometer."""
    print("")
    print("[calibration.lsm303d.magnetometer]")
    print("x_offset="+str(int(round(p[0]))))
    print("y_offset="+str(int(round(p[1]))))
    print("z_offset="+str(int(round(p[2]))))
    print("x_scale="+str(p[3]*2**res/2048))
    print("y_scale="+str(p[4]*2**res/2048))
    print("z_scale="+str(p[5]*2**res/2048))
    print("")
