...
class Barometer(object):
    ...
    def display(self):
        ...
        return ("%f 66 BARO_RAW %d %d" %
            (self.t/1000000.0, self.pres, self.temp))
...
class Mag(object):
    ...
    def display(self):
        if self.errormsg:
            return self.errormsg
        return ("%f 66 IMU_MAG_RAW %d %d %d" %
            (self.t/1000000.0, self.x, self.y, self.z))
...
class Accel(object):
    ...
    def display(self):
        if self.errormsg:
            return self.errormsg
        return ("%f 66 IMU_ACCEL_RAW %d %d %d \n %f 66 IMU_ACCEL %f %f %f" %
            (self.t/1000000.0, self.x, self.y, self.z, self.t/1000000.0, (self.x-7)/2048.0 * 9.80665, (self.y+19)/2048.0 * 9.80665, (self.z+8)/2048.0 * 9.80665))
...
class Gyro(object):
    ...
    def display(self):
        if self.errormsg:
            return self.errormsg
        return ("%f 66 IMU_GYRO_RAW %d %d %d" %
            (self.t/1000000.0, self.x, self.y, self.z))
