...
IVORY_BSP_STM32F4_GEN_DIR   := $(TOP)/src/bsp/ivory/tests/ledblink
IVORY_BSP_STM32F4_SANDBOX   := $(CONFIG_CABAL_SANDBOX)
IVORY_BSP_STM32F4_GEN_PROG  := ledblink-gen
IVORY_BSP_STM32F4_GEN_EXEC  := $(TOP)/src/bsp/ivory/ivory-bsp-stm32f4/dist/build/$(IVORY_BSP_STM32F4_GEN_PROG)/$(IVORY_BSP_STM32F4_GEN_PROG)
...
$(IVORY_BSP_STM32F4_GEN_EXEC):
	cabal-dev -s $(IVORY_BSP_STM32F4_SANDBOX) install --builddir=$(TOP)/src/bsp/ivory/ivory-bsp-stm32f4 \
	          $(TOP)/src/bsp/ivory/ivory-bsp-stm32f4
