...
mkUART :: (BitData a, IvoryIOReg (BitDataRep a))
       ...
       -> GPIO_AF
       -> UART
mkUART base rccreg rccfield tx rx af = UART
...
uart1 = mkUART uart1_periph_base regRCC_APB2ENR rcc_apb2en_uart1 pinB6  pinB7  gpio_af_uart1
uart2 = mkUART uart2_periph_base regRCC_APB1ENR rcc_apb1en_uart2 pinA2  pinA3  gpio_af_uart2
uart3 = mkUART uart3_periph_base regRCC_APB1ENR rcc_apb1en_uart3 pinB10 pinB12 gpio_af_uart3
uart4 = mkUART uart4_periph_base regRCC_APB1ENR rcc_apb1en_uart4 pinC10 pinC11 gpio_af_uart4
uart5 = mkUART uart5_periph_base regRCC_APB1ENR rcc_apb1en_uart5 pinC12 pinD2  gpio_af_uart5
uart6 = mkUART uart6_periph_base regRCC_APB2ENR rcc_apb2en_uart6 pinC6  pinC7  gpio_af_uart6
