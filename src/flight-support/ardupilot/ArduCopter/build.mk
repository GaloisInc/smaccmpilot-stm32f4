...
$(ARDUCOPTER_SKETCH_CPP): $(ARDUCOPTER_SKETCH_CPP_SRC)
	gawk -v mode=header -f $(TOP)/src/flight-support/ardupilot/mk/splitter.awk $(ARDUCOPTER_SKETCH_CPP_SRC) >  $@
	echo "#line 1 \"autogenerated\""                                                    >> $@
	gawk -f $(TOP)/src/flight-support/ardupilot/mk/prototyper.awk $(ARDUCOPTER_SKETCH_CPP_SRC)              >> $@
	gawk -v mode=body -f $(TOP)/src/flight-support/ardupilot/mk/splitter.awk $(ARDUCOPTER_SKETCH_CPP_SRC)   >> $@
